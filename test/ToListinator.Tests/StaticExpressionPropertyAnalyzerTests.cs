...
public class StaticExpressionPropertyAnalyzerTests
{
    ...
    [Fact]
    public async Task ShouldNotReportWarningForReadOnlySpanCollectionExpression()
    {
        const string testCode = """
        using System;
    ...
    [Fact]
    public async Task ShouldNotReportWarningForSpanCollectionExpression()
    {
        const string testCode = """
        using System;
        ...
        public class TestClass
        {
            public static ReadOnlySpan<int> Numbers => [1, 2, 3, 4, 5];
        }
        """;
    ...
    [Fact]
    public async Task ShouldReportWarningForListCollectionExpression()
    {
        const string testCode = """
        using System.Collections.Generic;
        ...
        public class TestClass
        {
            public static List<int> {|#0:Numbers|} => [1, 2, 3, 4, 5];
        }
        """;
